...
import com.atlassian.jira.rest.client.v2.model.ApplicationProperty;
import com.atlassian.jira.rest.client.v2.model.ModelConfiguration;
import com.atlassian.jira.rest.client.v2.model.SimpleApplicationPropertyBean;
...
public class JiraSettingsApi {
     ...
     */
    public Flux<ApplicationProperty> getAdvancedSettings() throws WebClientResponseException {
        ...
        ParameterizedTypeReference<ApplicationProperty> localVarReturnType = new ParameterizedTypeReference<ApplicationProperty>() {};
        return apiClient.invokeFluxAPI("/rest/api/2/application-properties/advanced-settings", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Flux<ApplicationProperty> getApplicationProperty(String key, String permissionLevel, String keyFilter) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        ParameterizedTypeReference<ApplicationProperty> localVarReturnType = new ParameterizedTypeReference<ApplicationProperty>() {};
        return apiClient.invokeFluxAPI("/rest/api/2/application-properties", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get global settings
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ModelConfiguration> getConfiguration() throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        ParameterizedTypeReference<ModelConfiguration> localVarReturnType = new ParameterizedTypeReference<ModelConfiguration>() {};
        return apiClient.invokeAPI("/rest/api/2/configuration", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ApplicationProperty> setApplicationProperty(String id, SimpleApplicationPropertyBean simpleApplicationPropertyBean) throws WebClientResponseException {
        Object postBody = simpleApplicationPropertyBean;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new WebClientResponseException("Missing the required parameter 'id' when calling setApplicationProperty", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'simpleApplicationPropertyBean' is set
        if (simpleApplicationPropertyBean == null) {
            throw new WebClientResponseException("Missing the required parameter 'simpleApplicationPropertyBean' when calling setApplicationProperty", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        ParameterizedTypeReference<ApplicationProperty> localVarReturnType = new ParameterizedTypeReference<ApplicationProperty>() {};
        return apiClient.invokeAPI("/rest/api/2/application-properties/{id}", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
