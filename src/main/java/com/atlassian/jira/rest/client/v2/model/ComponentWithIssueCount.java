...
public class ComponentWithIssueCount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueCount, realAssignee, isAssigneeTypeValid, realAssigneeType, description, self, lead, assigneeType, project, projectId, assignee, name, id);
  }
