...
public class IssueNavigatorSettingsApi {
     ...
     */
    public Flux<ColumnItem> getIssueNavigatorDefaultColumns() throws WebClientResponseException {
        ...
        return apiClient.invokeFluxAPI("/rest/api/2/settings/columns", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Object> setIssueNavigatorDefaultColumns(List<String> requestBody) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/2/settings/columns", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
