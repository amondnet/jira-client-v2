...
@JsonPropertyOrder({
  JqlQueryUnitaryOperand.JSON_PROPERTY_VALUE,
  JqlQueryUnitaryOperand.JSON_PROPERTY_FUNCTION,
  JqlQueryUnitaryOperand.JSON_PROPERTY_ARGUMENTS,
  JqlQueryUnitaryOperand.JSON_PROPERTY_KEYWORD
})
