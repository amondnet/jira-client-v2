...
import com.atlassian.jira.rest.client.v2.model.Votes;
...
public class IssueVotesApi {
     ...
     */
    public Mono<Object> addVote(String issueIdOrKey) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
            throw new WebClientResponseException("Missing the required parameter 'issueIdOrKey' when calling addVote", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/rest/api/2/issue/{issueIdOrKey}/votes", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get votes
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Votes> getVotes(String issueIdOrKey) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
            throw new WebClientResponseException("Missing the required parameter 'issueIdOrKey' when calling getVotes", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/rest/api/2/issue/{issueIdOrKey}/votes", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Delete vote
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> removeVote(String issueIdOrKey) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
            throw new WebClientResponseException("Missing the required parameter 'issueIdOrKey' when calling removeVote", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/rest/api/2/issue/{issueIdOrKey}/votes", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
