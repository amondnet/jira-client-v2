...
public class IssueSearchApiTest {
     ...
     */
    @Test
    public void getIssuePickerResourceTest()  {
        String query = null;
        ...
        IssuePickerSuggestions response = api.getIssuePickerResource(query, currentJQL, currentIssueKey, currentProjectId, showSubTasks, showSubTaskParent).block();
     ...
     */
    @Test
    public void matchIssuesTest()  {
        IssuesAndJQLQueries issuesAndJQLQueries = null;
        IssueMatches response = api.matchIssues(issuesAndJQLQueries).block();
     ...
     */
    @Test
    public void searchForIssuesUsingJqlTest()  {
        String jql = null;
        ...
        SearchResults response = api.searchForIssuesUsingJql(jql, startAt, maxResults, validateQuery, fields, expand, properties, fieldsByKeys).block();
     ...
     */
    @Test
    public void searchForIssuesUsingJqlPostTest()  {
        SearchRequestBean searchRequestBean = null;
        SearchResults response = api.searchForIssuesUsingJqlPost(searchRequestBean).block();
