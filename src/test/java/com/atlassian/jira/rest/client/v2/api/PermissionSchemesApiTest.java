...
public class PermissionSchemesApiTest {
     ...
     */
    @Test
    public void createPermissionGrantTest()  {
        Long schemeId = null;
        PermissionGrant permissionGrant = null;
        String expand = null;
        PermissionGrant response = api.createPermissionGrant(schemeId, permissionGrant, expand).block();
     ...
     */
    @Test
    public void createPermissionSchemeTest()  {
        Map<String, Object> requestBody = null;
        String expand = null;
        PermissionScheme response = api.createPermissionScheme(requestBody, expand).block();
     ...
     */
    @Test
    public void deletePermissionSchemeTest()  {
        Long schemeId = null;
        api.deletePermissionScheme(schemeId).block();
     ...
     */
    @Test
    public void deletePermissionSchemeEntityTest()  {
        Long schemeId = null;
        Long permissionId = null;
        api.deletePermissionSchemeEntity(schemeId, permissionId).block();
     ...
     */
    @Test
    public void getAllPermissionSchemesTest()  {
        String expand = null;
        PermissionSchemes response = api.getAllPermissionSchemes(expand).block();
     ...
     */
    @Test
    public void getPermissionSchemeTest()  {
        Long schemeId = null;
        String expand = null;
        PermissionScheme response = api.getPermissionScheme(schemeId, expand).block();
     ...
     */
    @Test
    public void getPermissionSchemeGrantTest()  {
        Long schemeId = null;
        Long permissionId = null;
        String expand = null;
        PermissionGrant response = api.getPermissionSchemeGrant(schemeId, permissionId, expand).block();
     ...
     */
    @Test
    public void getPermissionSchemeGrantsTest()  {
        Long schemeId = null;
        String expand = null;
        PermissionGrants response = api.getPermissionSchemeGrants(schemeId, expand).block();
     ...
     */
    @Test
    public void updatePermissionSchemeTest()  {
        Long schemeId = null;
        Map<String, Object> requestBody = null;
        String expand = null;
        PermissionScheme response = api.updatePermissionScheme(schemeId, requestBody, expand).block();
