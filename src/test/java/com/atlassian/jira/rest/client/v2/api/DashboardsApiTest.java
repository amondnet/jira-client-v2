...
public class DashboardsApiTest {
     ...
     */
    @Test
    public void copyDashboardTest()  {
        String id = null;
        DashboardDetails dashboardDetails = null;
        Dashboard response = api.copyDashboard(id, dashboardDetails).block();
    ...
    public void createDashboardTest()  {
        DashboardDetails dashboardDetails = null;
        Dashboard response = api.createDashboard(dashboardDetails).block();
     ...
     */
    @Test
    public void deleteDashboardItemPropertyTest()  {
        String dashboardId = null;
        String itemId = null;
        String propertyKey = null;
        api.deleteDashboardItemProperty(dashboardId, itemId, propertyKey).block();
    ...
    public void getAllDashboardsTest()  {
        ...
        PageOfDashboards response = api.getAllDashboards(filter, startAt, maxResults).block();
    ...
    public void getDashboardTest()  {
        String id = null;
        Dashboard response = api.getDashboard(id).block();
     ...
     */
    @Test
    public void getDashboardItemPropertyTest()  {
        String dashboardId = null;
        String itemId = null;
        String propertyKey = null;
        EntityProperty response = api.getDashboardItemProperty(dashboardId, itemId, propertyKey).block();
     ...
     */
    @Test
    public void getDashboardItemPropertyKeysTest()  {
        String dashboardId = null;
        String itemId = null;
        PropertyKeys response = api.getDashboardItemPropertyKeys(dashboardId, itemId).block();
     ...
     */
    @Test
    public void getDashboardsPaginatedTest()  {
        ...
        Integer maxResults = null;
        String expand = null;
        PageBeanDashboard response = api.getDashboardsPaginated(dashboardName, accountId, owner, groupname, projectId, orderBy, startAt, maxResults, expand).block();
     ...
     */
    @Test
    public void setDashboardItemPropertyTest()  {
        String dashboardId = null;
        String itemId = null;
        String propertyKey = null;
        Object body = null;
        Object response = api.setDashboardItemProperty(dashboardId, itemId, propertyKey, body).block();
    ...
    public void updateDashboardTest()  {
        String id = null;
        DashboardDetails dashboardDetails = null;
        Dashboard response = api.updateDashboard(id, dashboardDetails).block();
