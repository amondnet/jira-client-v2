...
public class ScreenSchemesApiTest {
     ...
     */
    @Test
    public void createScreenSchemeTest()  {
        ScreenSchemeDetails screenSchemeDetails = null;
        ScreenSchemeId response = api.createScreenScheme(screenSchemeDetails).block();
     ...
     */
    @Test
    public void deleteScreenSchemeTest()  {
        String screenSchemeId = null;
        api.deleteScreenScheme(screenSchemeId).block();
     ...
     */
    @Test
    public void getScreenSchemesTest()  {
        Long startAt = null;
        Integer maxResults = null;
        Set<Long> id = null;
        PageBeanScreenScheme response = api.getScreenSchemes(startAt, maxResults, id).block();
     ...
     */
    @Test
    public void updateScreenSchemeTest()  {
        String screenSchemeId = null;
        UpdateScreenSchemeDetails updateScreenSchemeDetails = null;
        Object response = api.updateScreenScheme(screenSchemeId, updateScreenSchemeDetails).block();
