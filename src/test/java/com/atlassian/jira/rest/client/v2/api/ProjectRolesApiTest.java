...
public class ProjectRolesApiTest {
    ...
    public void createProjectRoleTest()  {
        ...
        ProjectRole response = api.createProjectRole(createUpdateRoleRequestBean).block();
     ...
     */
    @Test
    public void deleteProjectRoleTest()  {
        Long id = null;
        Long swap = null;
        api.deleteProjectRole(id, swap).block();
     ...
     */
    @Test
    public void fullyUpdateProjectRoleTest()  {
        Long id = null;
        CreateUpdateRoleRequestBean createUpdateRoleRequestBean = null;
        ProjectRole response = api.fullyUpdateProjectRole(id, createUpdateRoleRequestBean).block();
    ...
    public void getAllProjectRolesTest()  {
        List<ProjectRole> response = api.getAllProjectRoles().collectList().block();
     ...
     */
    @Test
    public void getProjectRoleTest()  {
        String projectIdOrKey = null;
        Long id = null;
        ProjectRole response = api.getProjectRole(projectIdOrKey, id).block();
    ...
    public void getProjectRoleByIdTest()  {
        Long id = null;
        ProjectRole response = api.getProjectRoleById(id).block();
     ...
     */
    @Test
    public void getProjectRoleDetailsTest()  {
        String projectIdOrKey = null;
        Boolean currentMember = null;
        Boolean excludeConnectAddons = null;
        List<ProjectRoleDetails> response = api.getProjectRoleDetails(projectIdOrKey, currentMember, excludeConnectAddons).collectList().block();
    ...
    public void getProjectRolesTest()  {
        String projectIdOrKey = null;
        Map<String, URI> response = api.getProjectRoles(projectIdOrKey).block();
     ...
     */
    @Test
    public void partialUpdateProjectRoleTest()  {
        Long id = null;
        CreateUpdateRoleRequestBean createUpdateRoleRequestBean = null;
        ProjectRole response = api.partialUpdateProjectRole(id, createUpdateRoleRequestBean).block();
