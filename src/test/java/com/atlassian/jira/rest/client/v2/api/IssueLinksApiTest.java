...
public class IssueLinksApiTest {
     ...
     */
    @Test
    public void deleteIssueLinkTest()  {
        String linkId = null;
        api.deleteIssueLink(linkId).block();
     ...
     */
    @Test
    public void getIssueLinkTest()  {
        String linkId = null;
        IssueLink response = api.getIssueLink(linkId).block();
    ...
    public void linkIssuesTest()  {
        ...
        Object response = api.linkIssues(linkIssueRequestJsonBean).block();
