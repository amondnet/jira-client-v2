...
public class ProjectsApiTest {
    ...
    public void archiveProjectTest()  {
        ...
        Object response = api.archiveProject(projectIdOrKey).block();
    ...
    public void createProjectTest()  {
        ...
        ProjectIdentifiers response = api.createProject(projectInputBean).block();
    ...
    public void deleteProjectTest()  {
        ...
        api.deleteProject(projectIdOrKey, enableUndo).block();
     ...
     */
    @Test
    public void deleteProjectAsynchronouslyTest()  {
        String projectIdOrKey = null;
        api.deleteProjectAsynchronously(projectIdOrKey).block();
    ...
    public void getAllProjectsTest()  {
        ...
        List<Project> response = api.getAllProjects(expand, recent, properties).collectList().block();
    ...
    public void getAllStatusesTest()  {
        String projectIdOrKey = null;
        List<IssueTypeWithStatus> response = api.getAllStatuses(projectIdOrKey).collectList().block();
    ...
    public void getHierarchyTest()  {
        Long projectId = null;
        ProjectIssueTypeHierarchy response = api.getHierarchy(projectId).block();
     ...
     */
    @Test
    public void getNotificationSchemeForProjectTest()  {
        String projectKeyOrId = null;
        String expand = null;
        NotificationScheme response = api.getNotificationSchemeForProject(projectKeyOrId, expand).block();
    ...
    public void getProjectTest()  {
        ...
        String expand = null;
        List<String> properties = null;
        Project response = api.getProject(projectIdOrKey, expand, properties).block();
    ...
    public void restoreTest()  {
        String projectIdOrKey = null;
        Project response = api.restore(projectIdOrKey).block();
    ...
    public void searchProjectsTest()  {
        ...
        PageBeanProject response = api.searchProjects(startAt, maxResults, orderBy, query, typeKey, categoryId, action, expand, status, properties, propertyQuery).block();
    ...
    public void updateProjectTest()  {
        ...
        ProjectInputBean projectInputBean = null;
        String expand = null;
        Project response = api.updateProject(projectIdOrKey, projectInputBean, expand).block();
    ...
    public void updateProjectTypeTest()  {
        ...
        Project response = api.updateProjectType(projectIdOrKey, newProjectTypeKey).block();
