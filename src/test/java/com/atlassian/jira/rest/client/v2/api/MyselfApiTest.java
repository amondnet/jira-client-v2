...
public class MyselfApiTest {
     ...
     */
    @Test
    public void deleteLocaleTest()  {
        Object response = api.deleteLocale().block();
    ...
    public void getCurrentUserTest()  {
        String expand = null;
        User response = api.getCurrentUser(expand).block();
    ...
    public void getLocaleTest()  {
        Locale response = api.getLocale().block();
    ...
    public void getPreferenceTest()  {
        String key = null;
        String response = api.getPreference(key).block();
    ...
    public void removePreferenceTest()  {
        String key = null;
        api.removePreference(key).block();
    ...
    public void setLocaleTest()  {
        Locale locale = null;
        Object response = api.setLocale(locale).block();
    ...
    public void setPreferenceTest()  {
        String key = null;
        String body = null;
        Object response = api.setPreference(key, body).block();
