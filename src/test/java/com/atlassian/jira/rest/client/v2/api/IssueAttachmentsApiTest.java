...
public class IssueAttachmentsApiTest {
    ...
    public void addAttachmentTest()  {
        ...
        List<Attachment> response = api.addAttachment(issueIdOrKey).collectList().block();
     ...
     */
    @Test
    public void expandAttachmentForHumansTest()  {
        String id = null;
        AttachmentArchiveMetadataReadable response = api.expandAttachmentForHumans(id).block();
     ...
     */
    @Test
    public void expandAttachmentForMachinesTest()  {
        String id = null;
        AttachmentArchiveImpl response = api.expandAttachmentForMachines(id).block();
    ...
    public void getAttachmentTest()  {
        String id = null;
        AttachmentMetadata response = api.getAttachment(id).block();
     ...
     */
    @Test
    public void getAttachmentMetaTest()  {
        AttachmentSettings response = api.getAttachmentMeta().block();
