...
public class AvatarsApiTest {
    ...
    public void deleteAvatarTest()  {
        ...
        Long id = null;
        api.deleteAvatar(type, owningObjectId, id).block();
     ...
     */
    @Test
    public void getAllSystemAvatarsTest()  {
        String type = null;
        SystemAvatars response = api.getAllSystemAvatars(type).block();
    ...
    public void getAvatarsTest()  {
        ...
        Avatars response = api.getAvatars(type, entityId).block();
    ...
    public void storeAvatarTest()  {
        ...
        Integer x = null;
        Integer y = null;
        Avatar response = api.storeAvatar(type, entityId, size, body, x, y).block();
