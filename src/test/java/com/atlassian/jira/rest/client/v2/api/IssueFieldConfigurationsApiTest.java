...
public class IssueFieldConfigurationsApiTest {
     ...
     */
    @Test
    public void assignFieldConfigurationSchemeToProjectTest()  {
        FieldConfigurationSchemeProjectAssociation fieldConfigurationSchemeProjectAssociation = null;
        Object response = api.assignFieldConfigurationSchemeToProject(fieldConfigurationSchemeProjectAssociation).block();
     ...
     */
    @Test
    public void getAllFieldConfigurationSchemesTest()  {
        Long startAt = null;
        Integer maxResults = null;
        Set<Long> id = null;
        PageBeanFieldConfigurationScheme response = api.getAllFieldConfigurationSchemes(startAt, maxResults, id).block();
     ...
     */
    @Test
    public void getAllFieldConfigurationsTest()  {
        Long startAt = null;
        Integer maxResults = null;
        Set<Long> id = null;
        Boolean isDefault = null;
        String query = null;
        PageBeanFieldConfiguration response = api.getAllFieldConfigurations(startAt, maxResults, id, isDefault, query).block();
     ...
     */
    @Test
    public void getFieldConfigurationItemsTest()  {
        Long id = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanFieldConfigurationItem response = api.getFieldConfigurationItems(id, startAt, maxResults).block();
     ...
     */
    @Test
    public void getFieldConfigurationSchemeMappingsTest()  {
        Long startAt = null;
        Integer maxResults = null;
        Set<Long> fieldConfigurationSchemeId = null;
        PageBeanFieldConfigurationIssueTypeItem response = api.getFieldConfigurationSchemeMappings(startAt, maxResults, fieldConfigurationSchemeId).block();
     ...
     */
    @Test
    public void getFieldConfigurationSchemeProjectMappingTest()  {
        Set<Long> projectId = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanFieldConfigurationSchemeProjects response = api.getFieldConfigurationSchemeProjectMapping(projectId, startAt, maxResults).block();
