...
public class TimeTrackingApiTest {
     ...
     */
    @Test
    public void getAvailableTimeTrackingImplementationsTest()  {
        List<TimeTrackingProvider> response = api.getAvailableTimeTrackingImplementations().collectList().block();
     ...
     */
    @Test
    public void getSelectedTimeTrackingImplementationTest()  {
        TimeTrackingProvider response = api.getSelectedTimeTrackingImplementation().block();
     ...
     */
    @Test
    public void getSharedTimeTrackingConfigurationTest()  {
        TimeTrackingConfiguration response = api.getSharedTimeTrackingConfiguration().block();
     ...
     */
    @Test
    public void selectTimeTrackingImplementationTest()  {
        TimeTrackingProvider timeTrackingProvider = null;
        Object response = api.selectTimeTrackingImplementation(timeTrackingProvider).block();
     ...
     */
    @Test
    public void setSharedTimeTrackingConfigurationTest()  {
        TimeTrackingConfiguration timeTrackingConfiguration = null;
        TimeTrackingConfiguration response = api.setSharedTimeTrackingConfiguration(timeTrackingConfiguration).block();
