...
public class JqlApiTest {
    ...
    public void getAutoCompleteTest()  {
        JQLReferenceData response = api.getAutoComplete().block();
     ...
     */
    @Test
    public void getFieldAutoCompleteForQueryStringTest()  {
        String fieldName = null;
        String fieldValue = null;
        String predicateName = null;
        String predicateValue = null;
        AutoCompleteSuggestions response = api.getFieldAutoCompleteForQueryString(fieldName, fieldValue, predicateName, predicateValue).block();
     ...
     */
    @Test
    public void migrateQueriesTest()  {
        JQLPersonalDataMigrationRequest jqLPersonalDataMigrationRequest = null;
        ConvertedJQLQueries response = api.migrateQueries(jqLPersonalDataMigrationRequest).block();
     ...
     */
    @Test
    public void parseJqlQueriesTest()  {
        JqlQueriesToParse jqlQueriesToParse = null;
        String validation = null;
        ParsedJqlQueries response = api.parseJqlQueries(jqlQueriesToParse, validation).block();
