...
public class ProjectPropertiesApiTest {
     ...
     */
    @Test
    public void deleteProjectPropertyTest()  {
        String projectIdOrKey = null;
        String propertyKey = null;
        api.deleteProjectProperty(projectIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void getProjectPropertyTest()  {
        String projectIdOrKey = null;
        String propertyKey = null;
        EntityProperty response = api.getProjectProperty(projectIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void getProjectPropertyKeysTest()  {
        String projectIdOrKey = null;
        PropertyKeys response = api.getProjectPropertyKeys(projectIdOrKey).block();
     ...
     */
    @Test
    public void setProjectPropertyTest()  {
        String projectIdOrKey = null;
        String propertyKey = null;
        Object body = null;
        Object response = api.setProjectProperty(projectIdOrKey, propertyKey, body).block();
