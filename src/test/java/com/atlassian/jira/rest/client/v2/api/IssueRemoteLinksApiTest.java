...
public class IssueRemoteLinksApiTest {
     ...
     */
    @Test
    public void createOrUpdateRemoteIssueLinkTest()  {
        String issueIdOrKey = null;
        Map<String, Object> requestBody = null;
        RemoteIssueLinkIdentifies response = api.createOrUpdateRemoteIssueLink(issueIdOrKey, requestBody).block();
     ...
     */
    @Test
    public void deleteRemoteIssueLinkByGlobalIdTest()  {
        String issueIdOrKey = null;
        String globalId = null;
        api.deleteRemoteIssueLinkByGlobalId(issueIdOrKey, globalId).block();
     ...
     */
    @Test
    public void deleteRemoteIssueLinkByIdTest()  {
        String issueIdOrKey = null;
        String linkId = null;
        api.deleteRemoteIssueLinkById(issueIdOrKey, linkId).block();
     ...
     */
    @Test
    public void getRemoteIssueLinkByIdTest()  {
        String issueIdOrKey = null;
        String linkId = null;
        RemoteIssueLink response = api.getRemoteIssueLinkById(issueIdOrKey, linkId).block();
     ...
     */
    @Test
    public void getRemoteIssueLinksTest()  {
        String issueIdOrKey = null;
        String globalId = null;
        RemoteIssueLink response = api.getRemoteIssueLinks(issueIdOrKey, globalId).block();
     ...
     */
    @Test
    public void updateRemoteIssueLinkTest()  {
        String issueIdOrKey = null;
        String linkId = null;
        Map<String, Object> requestBody = null;
        Object response = api.updateRemoteIssueLink(issueIdOrKey, linkId, requestBody).block();
