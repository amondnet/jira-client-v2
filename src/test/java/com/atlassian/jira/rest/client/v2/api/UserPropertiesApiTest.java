...
public class UserPropertiesApiTest {
     ...
     */
    @Test
    public void deleteUserPropertyTest()  {
        String propertyKey = null;
        String accountId = null;
        String userKey = null;
        String username = null;
        api.deleteUserProperty(propertyKey, accountId, userKey, username).block();
    ...
    public void getUserPropertyTest()  {
        ...
        String userKey = null;
        String username = null;
        EntityProperty response = api.getUserProperty(propertyKey, accountId, userKey, username).block();
     ...
     */
    @Test
    public void getUserPropertyKeysTest()  {
        String accountId = null;
        String userKey = null;
        String username = null;
        PropertyKeys response = api.getUserPropertyKeys(accountId, userKey, username).block();
    ...
    public void setUserPropertyTest()  {
        ...
        String userKey = null;
        String username = null;
        Object response = api.setUserProperty(propertyKey, body, accountId, userKey, username).block();
