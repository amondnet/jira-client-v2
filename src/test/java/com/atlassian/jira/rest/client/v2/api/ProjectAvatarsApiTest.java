...
public class ProjectAvatarsApiTest {
     ...
     */
    @Test
    public void createProjectAvatarTest()  {
        String projectIdOrKey = null;
        Object body = null;
        Integer x = null;
        Integer y = null;
        Integer size = null;
        Avatar response = api.createProjectAvatar(projectIdOrKey, body, x, y, size).block();
     ...
     */
    @Test
    public void deleteProjectAvatarTest()  {
        String projectIdOrKey = null;
        Long id = null;
        api.deleteProjectAvatar(projectIdOrKey, id).block();
     ...
     */
    @Test
    public void getAllProjectAvatarsTest()  {
        String projectIdOrKey = null;
        ProjectAvatars response = api.getAllProjectAvatars(projectIdOrKey).block();
     ...
     */
    @Test
    public void updateProjectAvatarTest()  {
        String projectIdOrKey = null;
        Avatar avatar = null;
        Object response = api.updateProjectAvatar(projectIdOrKey, avatar).block();
