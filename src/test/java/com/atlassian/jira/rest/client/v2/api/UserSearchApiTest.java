...
public class UserSearchApiTest {
     ...
     */
    @Test
    public void findAssignableUsersTest()  {
        String query = null;
        ...
        List<User> response = api.findAssignableUsers(query, sessionId, username, accountId, project, issueKey, startAt, maxResults, actionDescriptorId, recommend).collectList().block();
     ...
     */
    @Test
    public void findBulkAssignableUsersTest()  {
        ...
        Integer startAt = null;
        Integer maxResults = null;
        List<User> response = api.findBulkAssignableUsers(projectKeys, query, username, accountId, startAt, maxResults).collectList().block();
     ...
     */
    @Test
    public void findUserKeysByQueryTest()  {
        String query = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanUserKey response = api.findUserKeysByQuery(query, startAt, maxResults).block();
    ...
    public void findUsersTest()  {
        ...
        List<User> response = api.findUsers(query, username, accountId, startAt, maxResults, property).collectList().block();
    ...
    public void findUsersByQueryTest()  {
        ...
        Long startAt = null;
        Integer maxResults = null;
        PageBeanUser response = api.findUsersByQuery(query, startAt, maxResults).block();
     ...
     */
    @Test
    public void findUsersForPickerTest()  {
        String query = null;
        Integer maxResults = null;
        ...
        FoundUsers response = api.findUsersForPicker(query, maxResults, showAvatar, exclude, excludeAccountIds, avatarSize, excludeConnectUsers).block();
     ...
     */
    @Test
    public void findUsersWithAllPermissionsTest()  {
        ...
        Integer startAt = null;
        Integer maxResults = null;
        List<User> response = api.findUsersWithAllPermissions(permissions, query, username, accountId, issueKey, projectKey, startAt, maxResults).collectList().block();
     ...
     */
    @Test
    public void findUsersWithBrowsePermissionTest()  {
        String query = null;
        String username = null;
        String accountId = null;
        String issueKey = null;
        ...
        Integer startAt = null;
        Integer maxResults = null;
        List<User> response = api.findUsersWithBrowsePermission(query, username, accountId, issueKey, projectKey, startAt, maxResults).collectList().block();
