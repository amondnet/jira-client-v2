...
public class WebhooksApiTest {
    ...
    public void deleteWebhookByIdTest()  {
        ...
        api.deleteWebhookById(containerForWebhookIDs).block();
     ...
     */
    @Test
    public void getDynamicWebhooksForAppTest()  {
        Long startAt = null;
        Integer maxResults = null;
        PageBeanWebhook response = api.getDynamicWebhooksForApp(startAt, maxResults).block();
     ...
     */
    @Test
    public void getFailedWebhooksTest()  {
        Integer maxResults = null;
        Long after = null;
        FailedWebhooks response = api.getFailedWebhooks(maxResults, after).block();
     ...
     */
    @Test
    public void refreshWebhooksTest()  {
        ContainerForWebhookIDs containerForWebhookIDs = null;
        WebhooksExpirationDate response = api.refreshWebhooks(containerForWebhookIDs).block();
     ...
     */
    @Test
    public void registerDynamicWebhooksTest()  {
        WebhookRegistrationDetails webhookRegistrationDetails = null;
        ContainerForRegisteredWebhooks response = api.registerDynamicWebhooks(webhookRegistrationDetails).block();
