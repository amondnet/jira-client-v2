...
public class IssueCustomFieldOptionsAppsApiTest {
     ...
     */
    @Test
    public void createIssueFieldOptionTest()  {
        String fieldKey = null;
        Map<String, Object> requestBody = null;
        IssueFieldOption response = api.createIssueFieldOption(fieldKey, requestBody).block();
     ...
     */
    @Test
    public void deleteIssueFieldOptionTest()  {
        String fieldKey = null;
        Long optionId = null;
        Object response = api.deleteIssueFieldOption(fieldKey, optionId).block();
     ...
     */
    @Test
    public void getAllIssueFieldOptionsTest()  {
        String fieldKey = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanIssueFieldOption response = api.getAllIssueFieldOptions(fieldKey, startAt, maxResults).block();
     ...
     */
    @Test
    public void getIssueFieldOptionTest()  {
        String fieldKey = null;
        Long optionId = null;
        IssueFieldOption response = api.getIssueFieldOption(fieldKey, optionId).block();
     ...
     */
    @Test
    public void getSelectableIssueFieldOptionsTest()  {
        String fieldKey = null;
        Long startAt = null;
        Integer maxResults = null;
        Long projectId = null;
        PageBeanIssueFieldOption response = api.getSelectableIssueFieldOptions(fieldKey, startAt, maxResults, projectId).block();
     ...
     */
    @Test
    public void getVisibleIssueFieldOptionsTest()  {
        String fieldKey = null;
        Long startAt = null;
        Integer maxResults = null;
        Long projectId = null;
        PageBeanIssueFieldOption response = api.getVisibleIssueFieldOptions(fieldKey, startAt, maxResults, projectId).block();
     ...
     */
    @Test
    public void replaceIssueFieldOptionTest()  {
        String fieldKey = null;
        Long optionId = null;
        Long replaceWith = null;
        String jql = null;
        api.replaceIssueFieldOption(fieldKey, optionId, replaceWith, jql).block();
     ...
     */
    @Test
    public void updateIssueFieldOptionTest()  {
        String fieldKey = null;
        Long optionId = null;
        IssueFieldOption issueFieldOption = null;
        IssueFieldOption response = api.updateIssueFieldOption(fieldKey, optionId, issueFieldOption).block();
