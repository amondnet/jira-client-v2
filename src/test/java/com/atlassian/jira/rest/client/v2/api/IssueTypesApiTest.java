...
public class IssueTypesApiTest {
    ...
    public void createIssueTypeTest()  {
        ...
        IssueTypeDetails response = api.createIssueType(issueTypeCreateBean).block();
    ...
    public void createIssueTypeAvatarTest()  {
        ...
        Integer x = null;
        Integer y = null;
        Avatar response = api.createIssueTypeAvatar(id, size, body, x, y).block();
    ...
    public void deleteIssueTypeTest()  {
        ...
        api.deleteIssueType(id, alternativeIssueTypeId).block();
    ...
    public void getAlternativeIssueTypesTest()  {
        String id = null;
        List<IssueTypeDetails> response = api.getAlternativeIssueTypes(id).collectList().block();
    ...
    public void getIssueAllTypesTest()  {
        List<IssueTypeDetails> response = api.getIssueAllTypes().collectList().block();
    ...
    public void getIssueTypeTest()  {
        String id = null;
        IssueTypeDetails response = api.getIssueType(id).block();
    ...
    public void updateIssueTypeTest()  {
        ...
        IssueTypeDetails response = api.updateIssueType(id, issueTypeUpdateBean).block();
