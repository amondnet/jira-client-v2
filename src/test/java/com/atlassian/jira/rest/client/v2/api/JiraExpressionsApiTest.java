...
public class JiraExpressionsApiTest {
     ...
     */
    @Test
    public void analyseExpressionTest()  {
        JiraExpressionForAnalysis jiraExpressionForAnalysis = null;
        String check = null;
        JiraExpressionsAnalysis response = api.analyseExpression(jiraExpressionForAnalysis, check).block();
     ...
     */
    @Test
    public void evaluateJiraExpressionTest()  {
        JiraExpressionEvalRequestBean jiraExpressionEvalRequestBean = null;
        String expand = null;
        JiraExpressionResult response = api.evaluateJiraExpression(jiraExpressionEvalRequestBean, expand).block();
