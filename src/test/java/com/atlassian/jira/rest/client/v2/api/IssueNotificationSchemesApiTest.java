...
public class IssueNotificationSchemesApiTest {
     ...
     */
    @Test
    public void getNotificationSchemeTest()  {
        Long id = null;
        String expand = null;
        NotificationScheme response = api.getNotificationScheme(id, expand).block();
     ...
     */
    @Test
    public void getNotificationSchemesTest()  {
        Long startAt = null;
        Integer maxResults = null;
        String expand = null;
        PageBeanNotificationScheme response = api.getNotificationSchemes(startAt, maxResults, expand).block();
