...
public class WorkflowSchemeProjectAssociationsApiTest {
    ...
    public void associateSchemeWithProjectTest()  {
        ...
        Object response = api.associateSchemeWithProject(workflowSchemeProjectAssociation).block();
    ...
    public void getWorkflowSchemeProjectAssociationsTest()  {
        ...
        ContainerOfWorkflowSchemeAssociations response = api.getWorkflowSchemeProjectAssociations(projectId).block();
