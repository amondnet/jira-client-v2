...
public class ApplicationRolesApiTest {
     ...
     */
    @Test
    public void getAllApplicationRolesTest()  {
        List<ApplicationRole> response = api.getAllApplicationRoles().collectList().block();
     ...
     */
    @Test
    public void getApplicationRoleTest()  {
        String key = null;
        ApplicationRole response = api.getApplicationRole(key).block();
