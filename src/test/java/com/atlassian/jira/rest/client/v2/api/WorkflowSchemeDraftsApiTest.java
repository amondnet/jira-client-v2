...
public class WorkflowSchemeDraftsApiTest {
     ...
     */
    @Test
    public void createWorkflowSchemeDraftFromParentTest()  {
        Long id = null;
        WorkflowScheme response = api.createWorkflowSchemeDraftFromParent(id).block();
     ...
     */
    @Test
    public void deleteDraftDefaultWorkflowTest()  {
        Long id = null;
        WorkflowScheme response = api.deleteDraftDefaultWorkflow(id).block();
     ...
     */
    @Test
    public void deleteDraftWorkflowMappingTest()  {
        Long id = null;
        String workflowName = null;
        api.deleteDraftWorkflowMapping(id, workflowName).block();
     ...
     */
    @Test
    public void deleteWorkflowSchemeDraftTest()  {
        Long id = null;
        api.deleteWorkflowSchemeDraft(id).block();
     ...
     */
    @Test
    public void deleteWorkflowSchemeDraftIssueTypeTest()  {
        Long id = null;
        String issueType = null;
        WorkflowScheme response = api.deleteWorkflowSchemeDraftIssueType(id, issueType).block();
     ...
     */
    @Test
    public void getDraftDefaultWorkflowTest()  {
        Long id = null;
        DefaultWorkflow response = api.getDraftDefaultWorkflow(id).block();
     ...
     */
    @Test
    public void getDraftWorkflowTest()  {
        Long id = null;
        String workflowName = null;
        IssueTypesWorkflowMapping response = api.getDraftWorkflow(id, workflowName).block();
     ...
     */
    @Test
    public void getWorkflowSchemeDraftTest()  {
        Long id = null;
        WorkflowScheme response = api.getWorkflowSchemeDraft(id).block();
     ...
     */
    @Test
    public void getWorkflowSchemeDraftIssueTypeTest()  {
        Long id = null;
        String issueType = null;
        IssueTypeWorkflowMapping response = api.getWorkflowSchemeDraftIssueType(id, issueType).block();
     ...
     */
    @Test
    public void setWorkflowSchemeDraftIssueTypeTest()  {
        Long id = null;
        String issueType = null;
        IssueTypeWorkflowMapping issueTypeWorkflowMapping = null;
        WorkflowScheme response = api.setWorkflowSchemeDraftIssueType(id, issueType, issueTypeWorkflowMapping).block();
     ...
     */
    @Test
    public void updateDraftDefaultWorkflowTest()  {
        Long id = null;
        DefaultWorkflow defaultWorkflow = null;
        WorkflowScheme response = api.updateDraftDefaultWorkflow(id, defaultWorkflow).block();
     ...
     */
    @Test
    public void updateDraftWorkflowMappingTest()  {
        Long id = null;
        String workflowName = null;
        IssueTypesWorkflowMapping issueTypesWorkflowMapping = null;
        WorkflowScheme response = api.updateDraftWorkflowMapping(id, workflowName, issueTypesWorkflowMapping).block();
     ...
     */
    @Test
    public void updateWorkflowSchemeDraftTest()  {
        Long id = null;
        WorkflowScheme workflowScheme = null;
        WorkflowScheme response = api.updateWorkflowSchemeDraft(id, workflowScheme).block();
