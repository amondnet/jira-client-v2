...
public class IssueCustomFieldContextsApiTest {
     ...
     */
    @Test
    public void addIssueTypesToContextTest()  {
        String fieldId = null;
        Long contextId = null;
        IssueTypeIds issueTypeIds = null;
        Object response = api.addIssueTypesToContext(fieldId, contextId, issueTypeIds).block();
     ...
     */
    @Test
    public void assignProjectsToCustomFieldContextTest()  {
        String fieldId = null;
        Long contextId = null;
        ProjectIds projectIds = null;
        Object response = api.assignProjectsToCustomFieldContext(fieldId, contextId, projectIds).block();
     ...
     */
    @Test
    public void createCustomFieldContextTest()  {
        String fieldId = null;
        CreateCustomFieldContext createCustomFieldContext = null;
        CreateCustomFieldContext response = api.createCustomFieldContext(fieldId, createCustomFieldContext).block();
     ...
     */
    @Test
    public void deleteCustomFieldContextTest()  {
        String fieldId = null;
        Long contextId = null;
        Object response = api.deleteCustomFieldContext(fieldId, contextId).block();
     ...
     */
    @Test
    public void getContextsForFieldTest()  {
        String fieldId = null;
        ...
        PageBeanCustomFieldContext response = api.getContextsForField(fieldId, isAnyIssueType, isGlobalContext, contextId, startAt, maxResults).block();
     ...
     */
    @Test
    public void getCustomFieldContextsForProjectsAndIssueTypesTest()  {
        String fieldId = null;
        ProjectIssueTypeMappings projectIssueTypeMappings = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanContextForProjectAndIssueType response = api.getCustomFieldContextsForProjectsAndIssueTypes(fieldId, projectIssueTypeMappings, startAt, maxResults).block();
    ...
    public void getDefaultValuesTest()  {
        ...
        Long startAt = null;
        Integer maxResults = null;
        PageBeanCustomFieldContextDefaultValue response = api.getDefaultValues(fieldId, contextId, startAt, maxResults).block();
     ...
     */
    @Test
    public void getIssueTypeMappingsForContextsTest()  {
        String fieldId = null;
        List<Long> contextId = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanIssueTypeToContextMapping response = api.getIssueTypeMappingsForContexts(fieldId, contextId, startAt, maxResults).block();
     ...
     */
    @Test
    public void getProjectContextMappingTest()  {
        String fieldId = null;
        Set<Long> contextId = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanCustomFieldContextProjectMapping response = api.getProjectContextMapping(fieldId, contextId, startAt, maxResults).block();
     ...
     */
    @Test
    public void removeCustomFieldContextFromProjectsTest()  {
        String fieldId = null;
        Long contextId = null;
        ProjectIds projectIds = null;
        Object response = api.removeCustomFieldContextFromProjects(fieldId, contextId, projectIds).block();
     ...
     */
    @Test
    public void removeIssueTypesFromContextTest()  {
        String fieldId = null;
        Long contextId = null;
        IssueTypeIds issueTypeIds = null;
        Object response = api.removeIssueTypesFromContext(fieldId, contextId, issueTypeIds).block();
    ...
    public void setDefaultValuesTest()  {
        ...
        Object response = api.setDefaultValues(fieldId, customFieldContextDefaultValueUpdate).block();
     ...
     */
    @Test
    public void updateCustomFieldContextTest()  {
        String fieldId = null;
        Long contextId = null;
        CustomFieldContextUpdateDetails customFieldContextUpdateDetails = null;
        Object response = api.updateCustomFieldContext(fieldId, contextId, customFieldContextUpdateDetails).block();
