...
public class PermissionsApiTest {
    ...
    public void getAllPermissionsTest()  {
        Permissions response = api.getAllPermissions().block();
     ...
     */
    @Test
    public void getBulkPermissionsTest()  {
        BulkPermissionsRequestBean bulkPermissionsRequestBean = null;
        BulkPermissionGrants response = api.getBulkPermissions(bulkPermissionsRequestBean).block();
     ...
     */
    @Test
    public void getMyPermissionsTest()  {
        ...
        Permissions response = api.getMyPermissions(projectKey, projectId, issueKey, issueId, permissions, projectUuid, projectConfigurationUuid).block();
     ...
     */
    @Test
    public void getPermittedProjectsTest()  {
        PermissionsKeysBean permissionsKeysBean = null;
        PermittedProjects response = api.getPermittedProjects(permissionsKeysBean).block();
