...
public class ProjectVersionsApiTest {
    ...
    public void createVersionTest()  {
        ...
        Version response = api.createVersion(version).block();
    ...
    public void deleteAndReplaceVersionTest()  {
        ...
        Object response = api.deleteAndReplaceVersion(id, deleteAndReplaceVersionBean).block();
    ...
    public void deleteVersionTest()  {
        ...
        api.deleteVersion(id, moveFixIssuesTo, moveAffectedIssuesTo).block();
    ...
    public void getProjectVersionsTest()  {
        ...
        String expand = null;
        List<Version> response = api.getProjectVersions(projectIdOrKey, expand).collectList().block();
    ...
    public void getProjectVersionsPaginatedTest()  {
        ...
        String status = null;
        String expand = null;
        PageBeanVersion response = api.getProjectVersionsPaginated(projectIdOrKey, startAt, maxResults, orderBy, query, status, expand).block();
    ...
    public void getVersionTest()  {
        String id = null;
        String expand = null;
        Version response = api.getVersion(id, expand).block();
    ...
    public void getVersionRelatedIssuesTest()  {
        String id = null;
        VersionIssueCounts response = api.getVersionRelatedIssues(id).block();
    ...
    public void getVersionUnresolvedIssuesTest()  {
        String id = null;
        VersionUnresolvedIssuesCount response = api.getVersionUnresolvedIssues(id).block();
    ...
    public void mergeVersionsTest()  {
        ...
        Object response = api.mergeVersions(id, moveIssuesTo).block();
    ...
    public void moveVersionTest()  {
        ...
        Version response = api.moveVersion(id, versionMoveBean).block();
    ...
    public void updateVersionTest()  {
        String id = null;
        Version version = null;
        Version response = api.updateVersion(id, version).block();
