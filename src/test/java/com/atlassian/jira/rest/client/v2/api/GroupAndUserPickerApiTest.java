...
public class GroupAndUserPickerApiTest {
     ...
     */
    @Test
    public void findUsersAndGroupsTest()  {
        String query = null;
        ...
        FoundUsersAndGroups response = api.findUsersAndGroups(query, maxResults, showAvatar, fieldId, projectId, issueTypeId, avatarSize, caseInsensitive, excludeConnectAddons).block();
