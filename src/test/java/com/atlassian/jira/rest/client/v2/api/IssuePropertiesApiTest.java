...
public class IssuePropertiesApiTest {
     ...
     */
    @Test
    public void bulkDeleteIssuePropertyTest()  {
        String propertyKey = null;
        IssueFilterForBulkPropertyDelete issueFilterForBulkPropertyDelete = null;
        api.bulkDeleteIssueProperty(propertyKey, issueFilterForBulkPropertyDelete).block();
     ...
     */
    @Test
    public void bulkSetIssuePropertyTest()  {
        String propertyKey = null;
        BulkIssuePropertyUpdateRequest bulkIssuePropertyUpdateRequest = null;
        api.bulkSetIssueProperty(propertyKey, bulkIssuePropertyUpdateRequest).block();
     ...
     */
    @Test
    public void bulkSetIssuesPropertiesTest()  {
        IssueEntityProperties issueEntityProperties = null;
        api.bulkSetIssuesProperties(issueEntityProperties).block();
     ...
     */
    @Test
    public void deleteIssuePropertyTest()  {
        String issueIdOrKey = null;
        String propertyKey = null;
        api.deleteIssueProperty(issueIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void getIssuePropertyTest()  {
        String issueIdOrKey = null;
        String propertyKey = null;
        EntityProperty response = api.getIssueProperty(issueIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void getIssuePropertyKeysTest()  {
        String issueIdOrKey = null;
        PropertyKeys response = api.getIssuePropertyKeys(issueIdOrKey).block();
     ...
     */
    @Test
    public void setIssuePropertyTest()  {
        String issueIdOrKey = null;
        String propertyKey = null;
        Object body = null;
        Object response = api.setIssueProperty(issueIdOrKey, propertyKey, body).block();
