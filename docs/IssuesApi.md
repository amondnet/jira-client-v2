...
[**getChangeLogs**](IssuesApi.md#getChangeLogs) | **GET** /rest/api/2/issue/{issueIdOrKey}/changelog | Get change logs
...
import com.atlassian.jira.rest.client.v2.api.IssuesApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        Boolean updateHistory = false; // Boolean | Whether the project in which the issue is created is added to the user's **Recently viewed** project list, as shown under **Projects** in Jira. This also populates the [JQL issues search](#api-rest-api-2-search-get) `lastViewed` field.
        try {
