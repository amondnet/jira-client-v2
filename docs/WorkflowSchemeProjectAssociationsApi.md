...
------------- | ------------- | -------------
[**associateSchemeWithProject**](WorkflowSchemeProjectAssociationsApi.md#associateSchemeWithProject) | **PUT** /rest/api/2/workflowscheme/project | Assign workflow scheme to project
...
import com.atlassian.jira.rest.client.v2.api.WorkflowSchemeProjectAssociationsApi;
