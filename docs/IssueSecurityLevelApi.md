...
import com.atlassian.jira.rest.client.v2.api.IssueSecurityLevelApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        IssueSecurityLevelApi apiInstance = new IssueSecurityLevelApi(defaultClient);
        Long issueSecuritySchemeId = 56L; // Long | The ID of the issue security scheme. Use the [Get issue security schemes](#api-rest-api-2-issuesecurityschemes-get) operation to get a list of issue security scheme IDs.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **issueSecuritySchemeId** | **Long**| The ID of the issue security scheme. Use the [Get issue security schemes](#api-rest-api-2-issuesecurityschemes-get) operation to get a list of issue security scheme IDs. |
